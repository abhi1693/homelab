...
locals {
  ...
  # renovate: datasource=docker depName=ghcr.io/abhi1693/home-lab versioning=regex:^python-3-12-(?<patch>\d{2})(?<minor>\d{2})(?<major>\d{4})$
  workspace_image = "ghcr.io/abhi1693/home-lab:python-3-12-17052026"
