...
locals {
  template_name       = "nodejs-22"
  workspace_namespace = "coder-workspaces"
  # renovate: datasource=docker depName=ghcr.io/abhi1693/home-lab versioning=regex:^nodejs-22-(?<patch>\d{2})(?<minor>\d{2})(?<major>\d{4})$
  workspace_image = "ghcr.io/abhi1693/home-lab:nodejs-22-13052026"
