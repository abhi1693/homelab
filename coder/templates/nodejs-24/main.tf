...
locals {
  ...
  # renovate: datasource=docker depName=ghcr.io/abhi1693/home-lab versioning=regex:^nodejs-24-(?<patch>\d{2})(?<minor>\d{2})(?<major>\d{4})$
  workspace_image = "ghcr.io/abhi1693/home-lab:nodejs-24-17052026"
